...
// Mendel90 hobbed bolt and 39:11 Wade's gears (Kevin on 4/26 modified this)
#define E_STEPS_PER_MM ((3200 * 39.0)/(11.0 * 6.75 * 3.142))*0.3487
...
#define STRING_CONFIG_H_AUTHOR "damian" //Who made the changes.
...
//Adjusted by Kevin 4/26 (no need for 0.2 offset)
#define Z_HOME_POS (188.3) 
//
...
#define HOMING_FEEDRATE {35*60, 35*60, 2*60, 0}  // set the homing speeds (mm/min) DKieran - original file had 4 for Z

// default settings 
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,200*16/1,E_TEPS_PER_MM}  // Mendel90 with Wades and Stoffel15 bolt 
#define DEFAULT_MAX_FEEDRATE          {60, 60, 2, 2}    // (mm/sec) DKieran - original file had 400 for X and Y and 4 for Z
#define DEFAULT_MAX_ACCELERATION      {200,200,15,5000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
